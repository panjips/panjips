...
export default function Project() {
  return (
    <>
      <Container className="bg-slate-950 flex-grow lg:py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-8 content-between">
          ...
          <Card
            url="/project/portofolio-website"
          ...
          <Card
            url="/project/edusync-web-api"
            image={"/images/mockup-edusync.png"}
            title="Edusync Web API"
          >
            Developed an API for Student Management System that help teacher to
            orgnized their student.
          </Card>
          <Card
            url="/project/walletfy-web-api"
